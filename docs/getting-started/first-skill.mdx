...
- Learn the complete [usage loop](https://nevitonsantana.github.io/adaptive-skills/how-to-use-a-skill/).
- Browse the [skill catalog](https://nevitonsantana.github.io/adaptive-skills/getting-started/skill-catalog/).
- For team adoption, continue to the [consumer adoption guide](https://nevitonsantana.github.io/adaptive-skills/consumer-adoption/).
