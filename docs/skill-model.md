...
Catalog growth is governed by the [Lean Skill Doctrine](skill-design-principles/lean-skill-doctrine.md) and [Skill Catalog Governance](skill-catalog-governance.md). A new skill, module, merge, split or deprecation should pass the [Skill Quality Gate](https://github.com/nevitonsantana/adaptive-skills/blob/main/templates/skill-quality-gate.md) before canon changes.
