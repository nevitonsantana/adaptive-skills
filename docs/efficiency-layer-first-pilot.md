...
A first-validation reference case (Crisis Monitor) is available in [`docs/efficiency-layer-crisis-monitor-reference.md`](https://nevitonsantana.github.io/adaptive-skills/efficiency-layer-crisis-monitor-reference/). Use it when you want one concrete field example of the trio mapped onto a real product lane without treating that product repo as the implementation target. Per [ADR-002](https://nevitonsantana.github.io/adaptive-skills/adr/ADR-002-domain-agnosticism/), this is the first concrete instance, not the canonical pattern.
