...
Full file: [`apm.yml`](https://github.com/nevitonsantana/adaptive-skills/blob/main/apm.yml). Adopter-facing companion: [`docs/guides/install-via-apm.md`](../guides/install-via-apm.md).
